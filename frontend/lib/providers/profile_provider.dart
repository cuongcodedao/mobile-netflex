...
import 'package:frontend/providers/auth_provider.dart'; // Import apiServiceProvider từ auth_provider
...
final profileProvider = FutureProvider.family<List<ProfileModel>, int>((ref, accountId) async {
  ...
  try {
    ...
    print('Profiles fetched successfully: $profiles'); // Log sau khi lấy danh sách profile
    return profiles;
  } catch (e) {
